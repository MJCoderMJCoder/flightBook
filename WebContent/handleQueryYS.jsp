...
<table width="100%">
  ...
  <tr>
    <td align="center" valign="middle">杨帅</td>
    <td align="center" valign="middle">男</td>
    <td align="center" valign="middle">山西省运城市</td>
    <td align="center" valign="middle">142723199412023839</td>
    <td align="center" valign="middle">18234149893</td>
    ...
    <td align="center" valign="middle"><form id="form1" name="form1" method="post" action="detail.jsp">
      <input type="submit" name="detail" id="detail" value="航班详情" />
    </form></td>
</tr> 
</table>
<table width="100%">
  <tr>
    <td align="center" valign="middle"><form id="back" name="back" method="post" action="query.jsp">
