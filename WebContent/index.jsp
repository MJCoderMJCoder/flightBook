...
<div id="Head">
  <div id="TicketHead">
    <div id="JpLeft">
      <div id="JpLeftTop">查询信息</div>
      <div id="JpLeftCenter">
        <form id="index" name="index" method="post" action="handleindex.jsp">
                ...
                <td height="70" colspan="4"><!---->
                  <table width="496" border="0" cellpadding="0" cellspacing="0" id="Fly01">
                    ...
                    <tr>
                      <td height="35" align="center" valign="middle">&nbsp;</td>
                      <td width="170" height="35" align="center" valign="middle">&nbsp;</td>
                      <td height="35" colspan="2" align="center" valign="middle"><input type="submit" name="query" id="query" value="查询" /></td>
                      </tr>
                  </table>
                  <!---->
